            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="mt-4" action="/updload-assignment" method="post" enctype="multipart/form-data">
                                @csrf
                                        <div class="form-group has-success">
                                            <label class="control-label">Lecture</label>
                                            <select class="form-control custom-select" name="lecture">
                                            @foreach($get_lecture as $lecture)
