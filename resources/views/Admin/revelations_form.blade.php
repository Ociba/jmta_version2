                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="revelation_one" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
                            <label for="Revelation Two" style="color:white">Revelation two</label>
                            <input type="text" name="revelation_two" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
                            <label for="Revelation Three" style="color:white">Revelation three</label>
                            <input type="text" name="revelation_three" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
                            <label for="Revelation Four" style="color:white">Revelation four</label>
                            <input type="text" name="revelation_four" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
                            <label for="Revelation Five" style="color:white">Revelation five</label>
                            <input type="text" name="revelation_five" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
                            <label for="Revelation Six" style="color:white">Revelation six</label>
                            <input type="text" name="revelation_six" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
                            <label for="Revelation Seven" style="color:white">Revelation seven</label>
                            <input type="text" name="revelation_seven" id="" class="form-control">
                        </div>
                        <div class="col-lg-6">
