                ...
                <form class="form-material m-t-40" action="/submit-assessment" method="post" enctype="multipart/form-data">
                 @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-line text-white" value="" name="question_one" required> 
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" id="example-email2" name="question_two" class="form-control text-white" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">(If in different slots please indicate).</label>
                        <input type="text" class="form-control" name="question_if" value="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">3.	In three to five sentences please describe your bible marathon experience?</label>
                        <input type="text" class="form-control" name="question_three" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="question_four" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">5.	Is it worth doing again?</label>
                        <input type="text" class="form-control" name="question_five" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="question_six" placeholder="" required> 
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="question_seven_one" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">(ii) worship</label>
                        <input type="text" class="form-control" name="question_seven_two" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">(iii) Meditation?</label>
                        <input type="text" class="form-control" name="question_seven_three" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">(iv) Waiting upon God i.e. quiet time?</label>
                        <input type="text" class="form-control" name="question_seven_four" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">8.	What challenges did you encounter during your Bible Marathon?</label>
                        <input type="text" class="form-control" name="question_eight" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">9.	Did you overcome those challenges?</label>
                        <input type="text" class="form-control" name="question_nine" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">10.	If yes, how did you overcome?</label>
                        <input type="text" class="form-control"  name="question_ten" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">11.	Would you like us to pray with you over anything in relation to the Bible Marathon?</label>
                        <input type="text" class="form-control" name="question_eleven" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">12.	Do you have any testimonies you would like to share with us? (Please share in full details)</label>
                        <input type="text" class="form-control" name="question_twelve" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">13.	 How did you get to know about the Bible Marathon?</label>
                        <input type="text" class="form-control" name="question_thirteen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">14.	 What made you decide to join?</label>
                        <input type="text" class="form-control" name="question_fourteen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="question_fifteen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">16.	 If so, what has been their experience of the Marathon (to the best of your knowledge)?</label>
                        <input type="text" class="form-control" name="question_sixteen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="question_seventeen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">18.	Will you please get two people to join the next Bible Marathon?</label>
                        <input type="text" class="form-control" name="question_eighteen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">19.	Are there any changes or improvements you would recommend in the Bible Marathon program??</label>
                        <input type="text" class="form-control" name="question_nineteen" placeholder="" required> 
                    </div>
                    <div class="form-group">
                        <label class="text-white">20.	What final word would you leave with the JMTA team?</label>
                        <input type="text" class="form-control" name="question_twenty" placeholder="" required> 
                    </div>
                    <div class="form-group">
                      ...
                      You can use your phone or tablet.  Please do your recording in day light or in good light.
                        ...
                        <input type="file" class="form-control" name="video_recording" placeholder="" required> 
                    </div>
