                ...
                <form action="#" class="validation-wizard wizard-circle">
                    ...
                    <section>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Nationality :</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">County :</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Marital Status :</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Denomination :</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Ministry:</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Local Church :</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Profession:</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Occupation :</label>
                                    <input type="tel" class="form-control" id="wphoneNumber2"> </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Payment Method:</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="wphoneNumber2">Attach Photo :</label>
